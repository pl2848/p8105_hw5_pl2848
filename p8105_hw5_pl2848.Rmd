...
- I think this is related to the power of the test. The power of test is nearly 1 when the effect size is larger than 4, which means that the proportion of times the null was rejected is nearly 100%, so the average estimated means would be closer to the true mean.
```{r}
library(patchwork)
